#!/usr/bin/env python3
"""Wake State — Crash Recovery & Persistence for Hermes agents.
...
DEFAULT_DATA_DIR = os.path.expanduser("~/.hermes/wake-state")
...
def main():
    parser = argparse.ArgumentParser(description="Wake State — Crash Recovery for Hermes")
